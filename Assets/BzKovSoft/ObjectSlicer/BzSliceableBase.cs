...
namespace BzKovSoft.ObjectSlicer
{
	...
	public abstract class BzSliceableBase : MonoBehaviour, IBzSliceable
	{
		...
		public bool dawnPartMain=false;
		...
		private Renderer[] GetRenderers(GameObject gameObject)
		{
			...
			var rightRenders = new List<Renderer>();
			foreach (var render in renders)
			{
				if (render.tag != "Blood")
				{
					rightRenders.Add(render);
				}
			}
			return rightRenders.ToArray();
		}
