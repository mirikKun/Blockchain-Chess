...
public class cgSimpleMove 
{
    ...
    /// <summary>
    /// Did this move lead to a pawn promoting to a other figure?
    /// </summary>
    public bool promotioned;    
    /// <summary>
    /// New figure index
    /// </summary>
    public sbyte promotionedType=1;    
    ...
    public virtual cgSimpleMove duplicate(){
        ...
        dup.promotioned =this.promotioned;
        dup.promotionedType = this.promotionedType;
        dup.time = this.time;
        dup.fatalityIndex = this.fatalityIndex;
        return dup;
