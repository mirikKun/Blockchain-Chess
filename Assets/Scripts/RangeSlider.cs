...
[AddComponentMenu("UI/Range Slider", 34)]
    ...
    public class RangeSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        [SerializeField] private TextMeshProUGUI lowHandleText;
        [SerializeField] private TextMeshProUGUI highHandleText;
        ...
        private void UpdateVisuals()
        {
            ...
            lowHandleText.text = LowValue.ToString();
            highHandleText.text = HighValue.ToString();
        }
